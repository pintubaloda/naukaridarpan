...
use App\Http\Controllers\Admin\AutomationAdminController;
use App\Http\Controllers\Admin\ExamAuthoringController;
use App\Http\Controllers\Admin\ExamApprovalController;
use App\Http\Controllers\Admin\KYCController as AdminKYCController;
use App\Http\Controllers\Admin\QtiAdminController;
...
Route::middleware(['auth', 'role:student'])->prefix('student')->name('student.')->group(function () {
    ...
    Route::post('/exam/{purchase}/autosave',         [StudentExamController::class, 'autosave'])->name('exam.autosave');
...
Route::middleware(['auth', 'role:admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::get('/interoperability',                  [QtiAdminController::class, 'interoperability'])->name('interoperability.index');
    Route::post('/interoperability',                 [QtiAdminController::class, 'storeIntegration'])->name('interoperability.store');
    Route::put('/interoperability/{integration}',    [QtiAdminController::class, 'updateIntegration'])->name('interoperability.update');
    Route::delete('/interoperability/{integration}', [QtiAdminController::class, 'destroyIntegration'])->name('interoperability.destroy');
    Route::get('/question-bank',                     [ExamAuthoringController::class, 'questionBank'])->name('question-bank.index');
    Route::post('/question-bank',                    [ExamAuthoringController::class, 'storeQuestionBankItem'])->name('question-bank.store');
    Route::put('/question-bank/{item}',              [ExamAuthoringController::class, 'updateQuestionBankItem'])->name('question-bank.update');
    Route::post('/question-bank/{item}/clone',       [ExamAuthoringController::class, 'cloneQuestionBankItem'])->name('question-bank.clone');
    Route::delete('/question-bank/{item}',           [ExamAuthoringController::class, 'destroyQuestionBankItem'])->name('question-bank.destroy');
    Route::get('/exam-templates',                    [ExamAuthoringController::class, 'templates'])->name('exam-templates.index');
    Route::post('/exam-templates',                   [ExamAuthoringController::class, 'storeTemplate'])->name('exam-templates.store');
    Route::put('/exam-templates/{template}',         [ExamAuthoringController::class, 'updateTemplate'])->name('exam-templates.update');
    Route::post('/exam-templates/{template}/clone',  [ExamAuthoringController::class, 'cloneTemplate'])->name('exam-templates.clone');
    Route::delete('/exam-templates/{template}',      [ExamAuthoringController::class, 'destroyTemplate'])->name('exam-templates.destroy');
    Route::post('/exam-templates/{template}/create-exam', [ExamAuthoringController::class, 'createExamFromTemplate'])->name('exam-templates.create-exam');
