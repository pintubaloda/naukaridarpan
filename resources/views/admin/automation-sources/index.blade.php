    ...
    <main>
      <div style="display:flex;justify-content:space-between;align-items:flex-start;gap:1rem;flex-wrap:wrap;margin-bottom:1.5rem">
        <div>
          ...
          <p class="text-muted" style="margin:0">n8n discovers RSS feeds and websites by subject, imports blog drafts, and syncs professor leads back into Laravel here.</p>
        </div>
      </div>
      ...
      <div class="g-grid" style="grid-template-columns:1.3fr .9fr;gap:1rem;align-items:start">
        <section class="card card-static">
          <div style="padding:1rem 1.25rem;border-bottom:1px solid var(--border-l)">
            <h3 style="font-size:1rem">Discovered Sources</h3>
          </div>
          <div class="tbl-wrap" style="border:none;border-radius:0">
            <table class="tbl">
              ...
              <tbody>
                ...
                @empty
                <tr><td colspan="5" class="text-muted text-center" style="padding:2rem">No automation sources have been synced from n8n yet.</td></tr>
                @endforelse
              </tbody>
            </table>
          </div>
        ...
        <section style="display:grid;gap:1rem">
          <div class="card card-static card-body">
            ...
            <div class="text-muted" style="font-size:.84rem;line-height:1.6">
              Use `X-N8N-Token` with the shared token from `.env` and point your workflows to the Laravel automation endpoints. This keeps source discovery, blog imports, and lead imports inside the same admin system.
            </div>
