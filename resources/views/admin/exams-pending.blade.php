          ...
          <div style="display:flex;align-items:flex-start;justify-content:space-between;gap:1rem;flex-wrap:wrap">
            <div style="flex:1;min-width:0">
              ...
              <div style="margin-top:.5rem;display:flex;gap:.4rem;flex-wrap:wrap">
                ...
                @if($paper->tao_sync_status)
                <span class="badge {{ ['synced'=>'badge-green','failed'=>'badge-red','pending'=>'badge-gold'][$paper->tao_sync_status ?? 'pending'] ?? 'badge-gray' }}">Legacy Sync: {{ ucfirst($paper->tao_sync_status ?? 'pending') }}</span>
                @endif
              </div>
